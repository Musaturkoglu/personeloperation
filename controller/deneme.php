<style>@import url("https://fonts.googleapis.com/css?family=Manrope:300,400,500,600,700&display=swap&subset=latin-ext");
...
<script>const toggleButton = document.querySelector('.dark-light');
